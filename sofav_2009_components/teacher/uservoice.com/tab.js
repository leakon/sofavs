...
UserVoice.Dialog.Overlay = {
  ...
  element: function() {
    if (!document.getElementById(this.id)){
      var dummy = document.createElement('div')
      dummy.innerHTML = '<div id="'+this.id+'" class="uservoice-component" onclick="UserVoice.Dialog.close(); return false;" style="display:none;"><p>Click anywhere to close</p></div>'
      document.body.appendChild(dummy.firstChild)
    }
    return document.getElementById(this.id)
  },
...
UserVoice.PopIn = {
  show: function() {
    ...
    var url = "http://leakontest01.uservoice.com/pages/general/widgets/popin.html?referer=" + referer;
    UserVoice.Dialog.show("<iframe src=\"" + url + "\" frameborder=\"0\" scrolling=\"no\" allowtransparency=\"true\" width=\"350px\" height=\"400px\"></iframe>");
  }
}

document.write("\r\n  <style type=\"text\/css\">\r\n    a#uservoice-feedback-tab {\r\n      position: fixed;\r\n      right: 0;\r\n      top: 40%;\r\n      display: block;\r\n      background: #f00 url(http:\/\/leakontest01.uservoice.com\/images\/feedback_tab.png) -2px 50% no-repeat;\r\n      text-indent: 4000px;\r\n      width: 25px;\r\n      height: 90px;\r\n      margin-top: -45px;\r\n      border: outset 1px #f00;\r\n      border-right: none;\r\n      z-index: 100001;\r\n    }\r\n    \r\n    a#uservoice-feedback-tab:hover {\r\n      background-color: #06c;\r\n      border: outset 1px #06c;\r\n      border-right: none;\r\n      cursor: pointer;\r\n    }\r\n\r\n    * html a#uservoice-feedback-tab {\r\n      position: absolute;\r\n      background-image: none;\r\n      filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='http:\/\/leakontest01.uservoice.com\/images\/feedback_tab.png');\r\n    }\r\n  <\/style>\r\n  \r\n  <a id=\"uservoice-feedback-tab\" onclick=\"this.blur(); try { UserVoice.PopIn.show(); return false; } catch(e){}\" href=\"http:\/\/leakontest01.uservoice.com\/?referer_type=tab\">Feedback<\/a>\r\n  \r\n")