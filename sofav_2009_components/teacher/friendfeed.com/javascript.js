...
var msg = {title:document.title, url:location.href, selection:(selection||'')};
...
if (!iframe) return;
url = 'https://friendfeed.com/share/bookmarklet/frame#' + p;
try {
...
if (msg) {
clearNode(byId("ff__container"));
var foreground = div(byId("ff__container"));
foreground.style.backgroundColor = "#ddddff";
foreground.style.border = "1px solid #ccc";
foreground.style.color = "black";
foreground.style.padding = "4px 10px 4px 10px";
foreground.style.margin = "2px";
foreground.style.zIndex = 2;
foreground.style.font = "14pt Arial";
foreground.style.fontStyle = "normal";
foreground.style.fontWeight = "normal";
foreground.appendChild(document.createTextNode(msg));
setTimeout(function() {
